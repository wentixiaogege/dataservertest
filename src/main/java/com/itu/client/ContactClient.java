...
public class ContactClient {
	...
	public static void main(String[] args) throws IOException {
		// rest/person
		String url0 = "http://localhost:8080/dataservertest/rest/addressbook/";
		String name = "jackli";
		
		postContacts(url0, name);
//		putContacts(url0, name);
	...
	public static void postContacts(String url, String name) throws IOException {
