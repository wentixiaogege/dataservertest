 ...
 */
public class SmartMeterRecord implements java.io.Serializable {
	...
	public SmartMeterRecord() {
	}

	public SmartMeterRecord(Integer smIndex, String smIeeeAddress, Integer rmsV1,
